#!/usr/bin/env python3
"""Count all employees in January 2025 sheet"""
...
def main():
    ...
    # January 2025 sheet
    sheet_id = '14rfFm49DNyESepj5Lfux1OG1QYbv5QtDTUXYh1FuNUU'

    print("="*120)
    print("JANUARY 2025 - COUNTING ALL OPL EMPLOYEES")
    print("="*120)
    ...
    try:
        ...
        print(f"\n{'='*120}")
        print(f"TOTAL OPL EMPLOYEES IN JANUARY 2025: {total_employees}")
        print(f"{'='*120}")
