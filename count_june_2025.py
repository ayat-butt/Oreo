#!/usr/bin/env python3
"""Count employees in June 2025 OPL sheet - from 'Employee' column"""
...
def main():
    ...
    # June 2025 sheet
    sheet_id = '1C6sZRGVqvLrt5kKMx7jwIw7EoI4tbgHeqpmohScPXIo'

    print("="*120)
    print("JUNE 2025 - COUNTING EMPLOYEES FROM 'EMPLOYEE' COLUMN IN OPL SHEET")
    print("="*120)
    ...
    try:
        ...
        print(f"\n{'='*120}")
        print(f"TOTAL OPL EMPLOYEES IN JUNE 2025: {count}")
        print(f"{'='*120}")
